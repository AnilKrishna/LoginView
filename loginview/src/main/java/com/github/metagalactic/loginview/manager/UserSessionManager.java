package com.github.metagalactic.loginview.manager;
...
import com.github.metagalactic.loginview.SmartCustomLogoutListener;
...
public class UserSessionManager {
     ...
     */
    public boolean setUserSession(Context context, @Nullable SmartUser smartUser) {
    ...
    public static boolean logout(Activity context, SmartUser user, SmartCustomLogoutListener smartCustomLogoutListener, @Nullable GoogleApiClient googleApiClient) {
        SharedPreferences preferences;
        try {
            preferences = context.getSharedPreferences(USER_PREFS, Context.MODE_PRIVATE);
            editor = preferences.edit();
